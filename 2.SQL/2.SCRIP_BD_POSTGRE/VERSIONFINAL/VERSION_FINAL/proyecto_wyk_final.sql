...
CREATE TYPE presentacion_mat AS ENUM ('KG', 'LT', 'UN');
...
CREATE TABLE materia_prima(
    ...
    cantidad_exist_materia_prima DECIMAL(10, 3) NOT NULL,
    presentacion_materia_prima presentacion_mat NOT NULL,
    descripcion_materia_prima VARCHAR(200) NULL,
...
CREATE TABLE ajuste_materia_prima(
    ...
    cantidad_ajustada_mat DECIMAL(10,3) NOT NULL,
	descripcion_ajust_mat VARCHAR(200) NULL,
...
CREATE TABLE proveedor(
	cedula_proveedor BIGINT PRIMARY KEY NOT NULL,
	...
	id_usuario_fk_proveedor INT NOT NULL,
	CONSTRAINT id_usuario_fk_proveedor FOREIGN KEY (id_usuario_fk_proveedor) REFERENCES usuario (id_usuario)
);
...
CREATE TABLE compra(
	...
	CONSTRAINT id_proveedor_fk_compra FOREIGN KEY (id_proveedor_fk_compra) REFERENCES proveedor (cedula_proveedor)
);

CREATE TABLE detalle_compra_materia_prima(
    id_det_compra_mat_prim SERIAL PRIMARY KEY,
    cantidad_mat_prima_comprada DECIMAL(10,3) NOT NULL,
...
CREATE TABLE produccion(
	...
	fecha_hora_produccion TIMESTAMP NOT NULL,
	fecha_cambio_estado TIMESTAMP NULL,
